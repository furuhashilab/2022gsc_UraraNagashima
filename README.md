...
先行研究（先行開発？）として、地図記号を使用したガチャガチャでは、ブシロードが「TAMA-KYU 地図記号キーホルダー」を作成していた。発売は2022年1月で、金額は300円。
...
である。これはアクリルキーホルダーで記号の辺と辺が繋がっていなくても表現できる。しかし、本研究で制作するフィギュアでは一筆書きのように繋げる方法が合っていると推測する。３Dプリンターで作成するには辺と辺が離れていると表現が困難だからである。そのため
地図記号のうち、
