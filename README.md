...
１.モデリングに使用したのは３D 制作アプリBlenderである。

２.3Ⅾプリンターで印刷、使用したものは自宅にあるプリンター「」

３.カプセルトイ本体に挿し込むポップ（広告）を作成。使用したアプリは
...
しかし、本研究で制作するフィギュアでは一筆書きのように繋げる方法が合っていると推測する。

３Dプリンターで作成するには辺と辺が離れていると表現が困難だからである。そのため地図記号のうち、
（図書館
検察庁
裁判所
交番
